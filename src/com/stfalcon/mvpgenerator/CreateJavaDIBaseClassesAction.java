...
public class CreateJavaDIBaseClassesAction extends AnAction
{
    ...
    private void create(final PsiDirectory directory, final Module module) {
        ...
        this.createFile(directory, NAME_FILE_APP, rootPackage, fileTemplateManager, "App.java");
        this.createFile(directory.createSubdirectory(NAME_DIR_COMPONENTS), NAME_FILE_APP_COMPONENT, rootPackage, fileTemplateManager, "AppComponent.java");
        this.createFile(directory.createSubdirectory(NAME_DIR_MODULES), NAME_FILE_APP_MODULE, rootPackage, fileTemplateManager, "AppModule.java");
        this.createFile(directory.createSubdirectory(NAME_DIR_FACTORIES), NAME_FILE_ACTIVITIES_INJECTOR_FACTORIES, rootPackage, fileTemplateManager, "ActivitiesInjectorFactories.java");
        this.createFile(directory.findSubdirectory(NAME_DIR_FACTORIES), NAME_FILE_FRAGMENTS_INJECTOR_FACTORIES, rootPackage, fileTemplateManager, "FragmentsInjectorFactories.java");
    }
